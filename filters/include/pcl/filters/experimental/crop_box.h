...
template <typename PointT>
using FunctorFilter = advanced::FunctorFilter<PointT, CropBoxFunctor<PointT>>;
 ...
 */
template <typename PointT>
class CropBox : public FunctorFilter<PointT> {
...
public:
  ...
  : FunctorFilter<PointT>(extract_removed_indices)
  {
    filter_name_ = "CropBox";
    FunctorFilter<PointT>::setFunctionObject(
  ...
  applyFilter(Indices& indices) override
  {
    ...
    FunctorFilter<PointT>::applyFilter(indices);
  }
...
private:
  ...
  using FunctorFilter<PointT>::getFunctionObject; // hide method
};
} // namespace experimental
} // namespace pcl